...
def _migrate(db: sqlite3.Connection) -> None:
    ...
    for column, ddl in (
        ...
        # What the line was quoted at, kept apart from what the vendor
        ...
        # writes a new line. Backfilling would have to invent a quote for
        # parts already received at a price nobody can now compare to.
