...
let printSurfaceOwner = "report";

function renderPrintTicket() {
  printSurfaceOwner = "ticket";
...
function wireReportsView() {
  ...
  window.addEventListener("beforeprint", () => {
    if (state.report && printSurfaceOwner === "report") {
...
function openCustomerEditor(customer, onSaved) {
